...
const COST_ITEMS = [
  ...
  { item: "Virtual office (optional)", estimate: "300-1,000 CZK / month" },
  { item: "Trade license fee", estimate: "1,000 CZK" },
  { item: "Total setup estimate", estimate: "~10,000-15,000 CZK" },
];
...
const ACCOUNTING_OPTIONS = ["Pohoda", "Money S3", "iDoklad", "External accountant"];
    ...
    <main className="mx-auto min-h-screen w-full max-w-6xl px-6 py-8">
      ...
      <section className="mt-10 rounded-3xl border border-(--line) bg-white p-8 shadow-[0_18px_38px_-30px_rgba(19,33,58,0.45)]">
        ...
        <p className="mt-4 max-w-3xl text-(--text-muted)">
          Required setup finance checkpoints from the company registration plan.
        </p>
      </section>
      ...
      <section className="mt-6 grid gap-4 lg:grid-cols-2">
        ...
        <article className="rounded-2xl border border-(--line) bg-white p-6">
          ...
          <ul className="mt-4 space-y-2 text-sm text-[#314567]">
            ...
            <li>Recommended practical target is 10,000-50,000 CZK.</li>
            <li>Working baseline in this plan is 10,000 CZK.</li>
